...
from .serializer import CourseSerializer, TutorSerializer1, VideoSerializer, CourseSerializer3, VideoEditSerializer, \
    UserSerializer, LoginSerializer, Practiceserializer, CourseSerializer4
